    ...
    return (
        <main className="delivery">
            ...
            <section className="delivery__buttons">
                <button type="submit" className="delivery__button">Add New Delivery Address</button>
                <Link to="/payment-method" className="delivery__button"><button type="submit">Proceed to Payment</button></Link>
            </section>
        </main>
    );
}
